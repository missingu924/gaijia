	...
	<body> 
		<form name="addOrModifyForm" id="addOrModifyForm" action="<%=contextPath%>/<%=basePath%>/Servlet?method=addOrModify4this" method="post"> 
			...
			<table width="700" align="center" class="detail_table detail_table-bordered detail_table-striped"> 
				...
				<tr> 
					<td> 
						<%=domainInstance.getPropertyCnName("userdepartmentname") %>: 
					</td> 
					<td> 
						<input name="userdepartmentname" type="text" id="userdepartmentname" value="<%=StringUtil.getNotEmptyStr(domainInstance.getUserdepartmentname(),"")%>" size="20"  > 
						<font color="red">*</font> 
					</td> 
				</tr> 
				<tr> 
