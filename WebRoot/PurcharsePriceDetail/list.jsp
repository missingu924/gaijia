...
<% 
	...
	// 该功能对象实例 
	PurcharsePriceDetailObj domainInstance = (PurcharsePriceDetailObj) request.getAttribute("domainInstance"); 
	// 该功能路径 
			...
			<table class="table table-bordered table-striped" align="center" width="98%"> 
				<thead> 
					<tr> 
						...
						<th><%=domainInstance.getPropertyCnName("parentid") %></th> 
						<th>操作</th> 
					</tr> 
				</thead> 
				<% 
				...
				<tr> 
					...
					<td><%=StringUtil.getNotEmptyStr(o.getPrice())%></td> 
					<td><%=StringUtil.getNotEmptyStr(o.getParentid())%></td> 
