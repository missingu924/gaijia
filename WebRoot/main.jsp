...
<frameset rows="72,*,20" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frameset cols="210,*" frameborder="no" border="0" framespacing="0">
    ...
    <frame src="<%=request.getContextPath()%>/VDispatchlists/Servlet?method=list4modify&ddate_start=<%=TimeUtil.date2str(TimeUtil.getTheFirstDayOfTheMonth(),"yyyy-MM-dd") %>" name="mainFrame" id="mainFrame" title="mainFrame"  border="0" framespacing="0"/>
  </frameset>
